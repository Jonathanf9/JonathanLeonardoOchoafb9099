...
public class Personabd {
    ...
    public boolean registrarPersona(Persona persona) {
        ...
        String sql = "INSERT INTO `bdejerciciov09`.`persona` (`idpersona`, `cedula`, `nombres`, `apellidos`, `direccion`, `correo`, `telefono`,`genero`) VALUES('" + String.valueOf(persona.getIdPersona()) + "', '" + persona.getCedula() + "', '" + persona.getNombre() + "', '" + persona.getApellidos() + "', '" + persona.getDireccion() + "', '" + persona.getCorreo() + "', '" + persona.getTelefono() + "', '" + persona.getGenero() + "');";
        try {
    ...
    public boolean actualizar(Persona persona) {
        ...
        String sql = "UPDATE `bdejerciciov09`.`persona` SET `cedula` = '" + persona.getCedula() + "', `nombres` = '" + persona.getNombre() + "', `apellidos` = '" + persona.getApellidos() + "', `direccion` = '" + persona.getDireccion() + "', `correo` = '" + persona.getCorreo() + "', `telefono` = '" + persona.getTelefono() + "', `genero` = '" + persona.getGenero() + "' WHERE (`idpersona` = '" + persona.getIdPersona() + "');";
        try {
    ...
    public boolean eliminar(Persona persona) {
        ...
        String sql = "DELETE FROM `bdejerciciov09`.`persona` WHERE (`idpersona` = '" + String.valueOf(persona.getIdPersona()) + "');";
        try {
    ...
    public List<Persona> obtenerPersonas() {
        ...
        ResultSet rs = null;
        String sql = "SELECT * FROM bdejerciciov09.persona;";
    ...
    public Persona getPersonaCedula(String cedula) {
        ...
        ResultSet rs = null;
        Persona c = null;
        String sql = "SELECT * FROM bdejerciciov09.persona where cedula like " + cedula + ";";
        try {
            co = new Conexion().conectarBaseDatos();
            stm = co.createStatement();
            rs = stm.executeQuery(sql);
    ...
    public List<Persona> getPersonaNombre(String nombre) {
        ...
        ResultSet rs = null;
        List<Persona> personasEncontradas = new ArrayList<>();
        String sql = "SELECT * FROM bdejerciciov09.persona where nombres like \"%" + nombre + "%\"";
        try {
            co = new Conexion().conectarBaseDatos();
            stm = co.createStatement();
            rs = stm.executeQuery(sql);
