...
public class ModelTableInventario extends AbstractTableModel {
    ...
    private String[] m_colNames = {"COD PRODUCTO", "DESCRIPCIÓN", "PRECIO COMPRA SIN IVA ", "PRECIO COMPRA CON IVA ", "PRECIO MAYORISTA ", "PRECIO CLIENTE FIJO ", "PRECIO CLIENTE NORMAL ", "CAN PRODUCTOS"};
